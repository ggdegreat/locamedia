...
https://github.com/jstrachan/scopt/blob/master/src/main/scala/scopt/Options.scala

It is version 1.1.2 as of August 31, 2011.
*/
...
case class OptionParser(
   ...
   * @param action callback function
   */
  def flagOpt(longopt: String, description: String, action: => Unit) =
